...
Please give it a star(⭐) to raise awareness about J2ME community, and support the development of this project. Read about introduction, setup-process, and history of Awesome J2ME in <a href="https://hstsethi.vercel.app/posts/programming/awesome-j2me">this blog post</a>. Also check out [Awesome Symbian](https://github.com/hstsethi/awesome-symbian) ⭐ 136 | 🐛 1 | 🌐 Java | 📅 2026-05-17.

<!--lint disable double-link-->

Proud to be featured in [Awesome](https://github.com/sindresorhus/awesome) ⭐ 497,855 | 🐛 103 | 📅 2026-08-18, [Hackclub](https://retrospect.hackclub.com/j2me), [Awesome Java](https://github.com/akullpp/awesome-java) ⭐ 48,788 | 🐛 2 | 📅 2026-08-19 and more.
...
* [NN JSON CLDC 1.0](https://github.com/gtrxAC/discord-j2me/tree/main/src/cc/nnproject/json) ⭐ 444 | 🐛 11 | 🌐 Java | 📅 2026-08-15 - Modified version of NN JSON for CLDC 1.0.
...
* [J2ME Loader](https://github.com/nikita36078/J2ME-Loader) ⭐ 2,620 | 🐛 219 | 🌐 Java | 📅 2026-02-06 - J2ME emulator for Android.
...
* [FreeJ2ME Plus](https://github.com/TASEmulators/freej2me-plus) ⭐ 190 | 🐛 37 | 🌐 Java | 📅 2026-08-19 - Active fork of FreeJ2ME.
...
* [Discord J2ME](https://github.com/gtrxAC/discord-j2me) ⭐ 444 | 🐛 11 | 🌐 Java | 📅 2026-08-15 - Unofficial Discord client for J2ME. Utilizes a proxy server for HTTP and gateway connections.
...
* [Awesome Symbian](https://github.com/hstsethi/awesome-symbian) ⭐ 136 | 🐛 1 | 🌐 Java | 📅 2026-05-17 - An Awesome List about everything related to Symbian, a discontinued mobile OS for ARM popular in the early 2000s. It supports J2ME applications.
...
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,341 | 🐛 66 | 🌐 Java | 📅 2026-08-19 - Bytecode editor that supports multiple decompilers.
